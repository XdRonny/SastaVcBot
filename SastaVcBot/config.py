## Disclaimer By Team GodseXD SastaVcBot
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/GodseXD/SastaVcBot")
USERS = getenv("5642402307")
...
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5642402307").split()))
ASSISTANT_NAME = getenv("ASSNAME")
COMMAND_PREFIXES = ("/ ! .").split()
IMG_1 = getenv("IMG_1", "https://te.legra.ph/file/556cedd975644a9e49c33.jpg")
