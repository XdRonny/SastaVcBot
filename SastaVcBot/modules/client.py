...
from SastaVcBot.tgcalls import calls, queues
from SastaVcBot.tgcalls.youtube import download
from SastaVcBot.tgcalls import convert as cconvert
from SastaVcBot.tgcalls.calls import client as ASS_ACC
from SastaVcBot.database.queue import (
    get_active_chats,
    is_active_chat,
    add_active_chat,
    remove_active_chat,
...
from SastaVcBot import BOT_NAME, BOT_USERNAME
from SastaVcBot import app
import SastaVcBot.tgcalls
from SastaVcBot.tgcalls import youtube
from SastaVcBot.config import (
    DURATION_LIMIT,
    que,
    SUDO_USERS,
    BOT_ID,
...
from SastaVcBot.utils.filters import command
from SastaVcBot.utils.decorators import errors, sudo_users_only
from SastaVcBot.utils.administrator import adminsOnly
from SastaVcBot.utils.errors import DurationLimitError
from SastaVcBot.utils.gets import get_url, get_file_name
from SastaVcBot.modules.admins import member_permissions
...
If you didn't know how to make your own bot then contact us at @Devilsserver and get help from us.
**🔗 Repo Link : https://github.com/GodseXD/SastaVcBot**
**Thanks !""",
       reply_markup=InlineKeyboardMarkup(
            [[
                    InlineKeyboardButton("Get Repo 📦", url=f"https://github.com/GodseXD/SastaVcBot")
                ],
